...
import com.custom.router_api.execption.NoRouteFoundException;
import com.custom.router_api.interf.IRouterGroup;
import com.custom.router_api.interf.IRouterRoot;
import com.custom.router_api.service.IService;
import com.custom.router_api.unit.ClassUtils;
...
public class Router {
    ...
    private static final String ROUTE_ROOT_PAKCAGE = "com.custom.router.routes";
    private static final String SDK_NAME = "Route";
    ...
    private static void loadInfo() throws Exception {
        ...
        for (String className : routerMap) {
            if (className.startsWith(ROUTE_ROOT_PAKCAGE + "." + SDK_NAME + SEPARATOR + SUFFIX_ROOT)) {
                ...
                ((IRouterRoot) (Class.forName(className).getConstructor().newInstance())).loadInto(Warehouse.groupsIndex);
            }
        }
    }
